...
class UserList extends StatefulWidget{
  ...
  String time;
  bool isread;
  UserList({@required this.text,@required this.ID,@required this.secText,@required this.image,@required this.time,@required this.isread});
    ...
    return GestureDetector(
      onTap: (){//when clicked go to the chat details aw to send messages
        Navigator.push(context, MaterialPageRoute(builder: (context){
          return ChatDetailsPage(widget.ID);
          // return Text("workingggg");
        }
